...
import cn.onlov.on_cms_common.cms.manager.assist.*;
...
import cn.onlov.on_cms_common.common.util.MapUtil;
...
//		Long otherTotal=0l;
		...
		Set<Entry<String, Long>> entryseSet=sortByValue(totalMap).entrySet();
		Integer len=0;
        for (Entry<String, Long> entry:entryseSet) {
        	if(len<9){
