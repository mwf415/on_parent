...
public class CmsConfigApiAct {
	...
	public void loginGet(HttpServletRequest request,HttpServletResponse response){
		Config.ConfigLogin login = configMng.getConfigLogin();
	...
	public void loginUpdate(Config.ConfigLogin configLogin, Config.ConfigEmailSender emailSender,
							Config.ConfigMessageTemplate msgTpl, HttpServletRequest request, HttpServletResponse response){
		String body = "\"\"";
		String message = Constants.API_MESSAGE_PARAM_REQUIRED;
		String code = ResponseCode.API_CODE_PARAM_REQUIRED;
		WebErrors errors = WebErrors.create(request);
	...
	private JSONObject createLoginJson(Config.ConfigLogin login, EmailSender sender, MessageTemplate passwordMT,
