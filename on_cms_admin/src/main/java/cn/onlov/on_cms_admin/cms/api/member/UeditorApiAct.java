...
import cn.onlov.on_cms_common.cms.ueditor.PathFormat;
import cn.onlov.on_cms_common.cms.ueditor.define.AppInfo;
import cn.onlov.on_cms_common.cms.ueditor.define.BaseState;
import cn.onlov.on_cms_common.cms.ueditor.define.MultiState;
import cn.onlov.on_cms_common.cms.ueditor.define.State;
import cn.onlov.on_cms_common.cms.ueditor.hunter.ImageHunter;
import cn.onlov.on_cms_common.cms.ueditor.upload.StorageManager;
...
public class UeditorApiAct {
	...
	public void upload(
		...
		if(mark==null){
			mark=site.getConfig().getMarkConfig().getOn();
		}
